...
public class ventana_añadir_armaS extends JFrame {
	...
	public ventana_añadir_armaS() {
		...
		JButton btnNewButton = new JButton("AÑADIR ARMA SECUNDARIA");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArmaSecundariaBD.insertarArmaSecundaria(s);
