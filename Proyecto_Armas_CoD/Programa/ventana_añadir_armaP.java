...
public class ventana_añadir_armaP extends JFrame {
	...
	public ventana_añadir_armaP() {
		...
		JButton btnNewButton = new JButton("AÑADIR ARMA PRINCIPAL");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArmaPrincipalBD.insertarArmaPrincipal(p);
